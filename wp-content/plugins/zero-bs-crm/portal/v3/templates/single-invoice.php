		...
		// ============== / Brute force blocking
				...
				if ($hashOK['success'] == 1){
					...
					if (is_user_logged_in() && $invID > 0){
						...
						$contactID = zeroBSCRM_invoice_getContactAssigned((int)$invID);

						if ($contactID == $cID || zeroBSCRM_permsInvoices()){
				 	...
				 	if($showViewingAsAdmin){  
				 		?><div class='wrapper' style="padding-left:20px;padding-right:20px;padding-bottom:20px;">
							<div class='alert alert-info'>
								...
								<?php ##WLREMOVE ?>
								<a style="color:orange;font-size:18px;" href="https://kb.jetpackcrm.com/knowledge-base/how-does-the-client-portal-work/" target="_blank"><?php _e('Learn more about the client portal','zero-bs-crm'); ?></a>
								<?php ##/WLREMOVE ?>
							</div>
						...
						<?php zeroBSCRM_portal_single_invoice($invID,$invHash); ?>
					</div>
