	...
	<?php
		...
		<div class='wrapper'>
				...
				<div class='alert alert-info'>
					...
					<?php ##WLREMOVE ?>
					<br />Learn more about the client portal <a style="color:orange;font-size:18px;" href="https://kb.jetpackcrm.com/knowledge-base/how-does-the-client-portal-work/" target="_blank">here</a>
					<?php ##/WLREMOVE ?>
				</div>
				...
				<div class='zbs-portal-wrapper-sin zbs-single-quote-portal' style="padding:20px;">
					<?php
					echo zeroBSCRM_quote_generatePortalQuoteHTML($quoteID);
					?>
				</div>
