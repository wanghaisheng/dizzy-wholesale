        ...
        public function html( $quote, $metabox ) {
                ...
                <table class="form-table wh-metatab wptbp" id="wptbpMetaBoxMainItem">
                    ...
                    if (!empty($quoteID) && $quoteID > 0){
                        ...
                        ?><tr class="wh-large"><th><label for="quoteid"><?php _e('Quote (ID)',"zero-bs-crm");?>:</label></th>
                        <td>
                    ...
                    ?><tr class="wh-large"><th><label for="zbscq_customer"><?php _e('Contact',"zero-bs-crm");?>:</label></th>
                    <td><?php
                        ...
                        #} 27/09/16 - switched select for typeahead
                            ...
                            $prefillStr = ''; if (isset($quoteContactID) && !empty($quoteContactID)){
                                ...
                                #$zbsCustomer = zeroBS_getCustomer($quoteContactID);
                                #this was, for some reason, bugging out. $prefillStr = zeroBS_getCustomerName($quoteContactID);
                                $prefillStr = zeroBS_getCustomerNameShort($quoteContactID);
            ...
            if (!defined('ZBS_OBJ_SAVED')){
                ...
                if (empty($quoteID) || $quoteID < 1)  $quoteID = -1;
                    ...
                    */
                    ...
                    if ($zbsQuoteContact > 0) $quote['contacts'] = array($zbsQuoteContact);
                    $zbsQuoteCompany = -1; if (isset($_POST['zbscq_company'])) $zbsQuoteCompany = (int)sanitize_text_field($_POST['zbscq_company']);
                    if ($zbsQuoteCompany > 0) $quote['companies'] = array($zbsQuoteCompany);
   ...
   ====================================================== */
    ...
    class zeroBS__Metabox_QuoteContent extends zeroBS__Metabox{ 
        ...
        public function html( $quote, $metabox ) {
            ...
            wp_editor( $content, 'zbs_quote_content', array('editor_height',580));
                                    ...
                                    #} WH second change, only showed if dompdf extension installed
                                            if (zeroBSCRM_isExtensionInstalled('pdfinv')){
                                                ...
                                                jQuery(document).ready(function(){
                                                    ...
                                                    // on click
                                                    jQuery('#jpcrm_quote_download_pdf').click(function(){
                    ...
                    */
                    ...
                    <div class="zbs-quote-actions-bottom zbs-objedit-actions-bottom">
                        ...
                        <?php
                         ...
                         if ( zeroBSCRM_permsQuotes() ) { 
                        ?><div id="zbs-quote-actions-delete zbs-objedit-actions-delete">
