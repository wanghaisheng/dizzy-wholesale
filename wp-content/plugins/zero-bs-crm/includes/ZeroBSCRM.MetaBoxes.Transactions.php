   ...
   ====================================================== */
	...
	function zbs_transactions_meta_box_markup(){
	    ...
	    if($meta == ''){ ?>
		    ...
		    <table class="form-table wh-metatab wptbp">
		        ...
		        <tr class="wh-large">
                    ...
                    <?php if (zeroBSCRM_getSetting('companylevelcustomers') != "1"){ 
                    		...
                    		// Just contact
                    		?><label for"customer-ta"><?php _e("Customer","zero-bs-crm"); ?></label><?php
                    		...
                    		// contact or co
                    		?><div class="ui grid"><div class="seven wide column"><label for"customer-ta"><?php _e("Customer","zero-bs-crm"); ?></label><br /><?php
                    		...
                    		<div id="invoiceFieldWrap" style="position:relative;display:none" class="assignInvToCust">
                    		 ...
                    		 ?></div><div class="two wide column centered"><?php _e('Or','zero-bs-crm'); ?></div><div class="seven wide column"><label for"company-ta"><?php echo jpcrm_label_company(); ?></label><br /><?php
    		...
    		*/
		    ...
		    <table class="form-table wh-metatab wptbp">
		        ...
		        <tr><td colspan="2"><h2><?php _e("Assign to a Contact or ".jpcrm_label_company()." (Optional)","zero-bs-crm");?></td></tr>
		        ...
		        <tr class="wh-large" id="zbs-transaction-assignment-wrap">
                    ...
                    <?php if (zeroBSCRM_getSetting('companylevelcustomers') != "1"){ 
                    		...
                    		// Just contact
                    		?><div id="zbs-customer-title"><label for"customer-ta"><?php _e("Customer","zero-bs-crm"); ?></label></div><?php
                    		echo zeroBSCRM_CustomerTypeList('zbscrmjs_transaction_setCustomer', $customerName,false,'zbscrmjs_transaction_unsetCustomer');
                    		...
                    		<div id="invoiceFieldWrap" style="position:relative;display:none;max-width:658px" class="assignInvToCust"><input style="max-width:200px" id="invoice_id" name="invoice_id" value="<?php if(isset($meta['invoice_id'])){ echo $meta['invoice_id']; } ?>" class="form-control" autocomplete="zbstra-<?php echo time(); ?>-<?php echo rand(0,100); ?>" /></div><?php
                    		 ...
                    		 ?></div><div class="two wide column centered"><?php _e('Or','zero-bs-crm'); ?></div><div class="seven wide column"><div id="zbs-company-title"><label for"company-ta"><?php _e("Company","zero-bs-crm"); ?></label></div><?php
		...
		function zeroBSCRMJS_bindInvSelect(){
			...
			jQuery('#invoice_id').change(function(){
		...
		function zeroBSCRMJS_bindInvLinkIf(){
			...
			jQuery('#invoiceSelectionTitle .zbs-view-invoice').off('click').click(function(){
		...
		function zeroBSCRMJS_bindContactLinkIf(){
			...
			jQuery('#zbs-customer-title .zbs-view-contact').off('click').click(function(){
		...
		function zeroBSCRMJS_bindCompanyLinkIf(){
			...
			jQuery('#zbs-company-title .zbs-view-company').off('click').click(function(){
