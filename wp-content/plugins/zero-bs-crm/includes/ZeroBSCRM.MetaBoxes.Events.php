       ...
       public function print_actions_box($post, $metabox){
            ...
            <style>
              ...
              <label><b><?php _e("Notify CRM User:","zero-bs-crm");?></b>
                <?php ##WLREMOVE 
                ?><a class='help' href="https://kb.jetpackcrm.com/article-categories/calendar/" target="_blank"><?php _e("Need help?","zero-bs-crm");?></a><?php 
                ##/WLREMOVE ?>
              </label><br>
              <div class='field-group'>
                  <span><input type="radio" class="form-control" name="notify_crm" value="0" <?php if($zbsEventActions['notify'] == 0){ echo 'checked'; } ?> id="zbs-task-opt-never"> <label for="zbs-task-opt-never"><?php _e("Never","zero-bs-crm");?></label></span><br>
                  <span><input type="radio" class="form-control" name="notify_crm" value="24" <?php if($zbsEventActions['notify'] == 24){ echo 'checked'; } ?> id="zbs-task-opt-24"> <label for="zbs-task-opt-24"><?php _e("24 Hours before","zero-bs-crm");?></label></span><br>
              ...
              <div class='field-group'>
                <label><b><?php _e("Mark Complete:","zero-bs-crm"); ?></b> <a class='help' href="https://kb.jetpackcrm.com/article-categories/calendar/" target="_blank"><?php _e("Need help?","zero-bs-crm");?></a></label><br>
                <input type="checkbox" name="complete_crm" value="1" id="zbs-task-opt-completed" <?php if($zbsEventActions['complete'] == 1){ echo 'checked'; } ?>><span class='completed'><label for="zbs-task-opt-completed"><?php _e('Completed',"zero-bs-crm"); ?></label></span><br>
              </div>
