  ...
  / Breaking Checks
   ...
   #} Your style func
	function zbscrm_customer_search_custom_css(){
		wp_enqueue_style( 'zbs-customer-search', ZEROBSCRM_URL.'css/ZeroBSCRM.admin.customersearch.min.css', 'customer-search-bs' );
	}
   		...
   		<div class='container'>
   				<div class='row customer-list' style="margin-right:70px;">
   					<div class='col-md-8 header-pad'>
   						<h4 class='customer-header'><?php _e('Export Contacts','zerbscrm'); ?></h4>
   						<div class='actions'>
		        ...
		        <?php } ;?>
   						...
   						<div class='mid-banner'>
							...
							$zbstermc = sprintf( _n( '%s Contact', '%s Contacts', $zbs_customer_total_global, 'zero-bs-crm' ), $zbs_customer_total_global);
   							...
   							?>
   							<a href='<?php echo zbsLink($zbs->slugs['customer-search']);?>'><span class='lead'><?php _e('All Contacts');?></span><span class='sub-count'><?php echo $zbstermc; ?></span></a>
   						</div>
   						<div class='section'>
