...
function zeroBS_onboardme_scripts(){
    ...
    wp_enqueue_script('onboardme-front', ZEROBSCRM_URL . 'js/lib/hopscotch.min.js',array('jquery'));
    wp_enqueue_style('onboardme-css',  ZEROBSCRM_URL . 'css/lib/hopscotch.min.css' );
    wp_enqueue_script('tour-front', ZEROBSCRM_URL . 'js/ZeroBSCRM.admin.tour.min.js',array('jquery','onboardme-front'));
    ...
    $zbs_tour = array(
        ...
        'lang' => array(
            ...
            'step2' => array(
                ...
                'content' => __("There are ","zero-bs-crm").'<strong>'.__("Learn","zero-bs-crm").'</strong> '.__("buttons throughout the CRM. Use these to find out more about each area. Try clicking this one!","zero-bs-crm"),
            ),
            'step3' => array(
