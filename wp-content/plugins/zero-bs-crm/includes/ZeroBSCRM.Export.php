...
function zeroBSCRM_pages_export_tools(){ ?>
	...
	if(isset($_GET['zbswhat']) && $_GET['zbswhat'] == 'companies'){
		...
		if ( $b2bMode == 1 ){
			...
			echo "<p>";
			_e("Choose which fields you want to export. Total ".jpcrm_label_company(true)." in database: ","zerbscrm"); 
			echo "<b>" . $co . "</b>";
			echo "</p>";
	...
	if(isset($_GET['zbswhat']) && $_GET['zbswhat'] == 'contacts'){
			...
			echo "<p>";
			_e("Choose which fields you want to export. Total ". $zbs_cust ." in database: ","zerbscrm"); 
			echo "<b>" . $co . "</b>";
			echo "</p>";
	    ...
	    //    zbs_prettyprint($fields);
			...
			echo '<input type="checkbox" name="zbs_export_group[]" value="id" /> ID<br />';
				...
				<br/>
				<?php wp_nonce_field( 'zbs_export', 'zbs_export_field' ); ?>
		       <input type="submit" name="download_cust_csv" class="button-primary" value="<?php _e('Export Contacts'); ?>" />
	...
	if(isset($_GET['zbswhat']) && $_GET['zbswhat'] == 'invoices'){
			...
			$co = zeroBS_invCount();
			echo "<p>";
			_e("Total Invoices in database: ","zerbscrm"); 
			echo "<b>" . $co . "</b>";
			echo "</p>";
			?>
		...
		<form method="post" id="download_form" action="">
			<?php wp_nonce_field( 'zbs_export', 'zbs_export_field' ); ?>
	         <input type="submit" name="download_inv_csv" class="button-primary" value="<?php _e('Export Invoices'); ?>" />
	    </form>
    	<?php 
	}
	...
	if(isset($_GET['zbswhat']) && $_GET['zbswhat'] == 'quotes'){
			...
			$co = zeroBS_quoCount();
			echo "<p>";
			_e("Total Quotes in database: ","zerbscrm"); 
			echo "<b>" . $co . "</b>";
			echo "</p>";
			?>
		...
		<form method="post" id="download_form" action="">
			<?php wp_nonce_field( 'zbs_export', 'zbs_export_field' ); ?>
	            <input type="submit" name="download_quo_csv" class="button-primary" value="<?php _e('Export Quotes'); ?>" />
	    </form>
    	<?php 
	}
	...
	if(isset($_GET['zbswhat']) && $_GET['zbswhat'] == 'transactions'){
			...
			$co = zeroBS_tranCount();
			echo "<p>";
			_e("Total Transactions in database: ","zerbscrm"); 
			echo "<b>" . $co . "</b>";
			echo "</p>";
			?>
		...
		<form method="post" id="download_form" action="">
			<?php wp_nonce_field( 'zbs_export', 'zbs_export_field' ); ?>
	            <input type="submit" name="download_trans_csv" class="button-primary" value="<?php _e('Export Transactions','zeronbscrm'); ?>" />
	    </form>
    	<?php 
	}
?>
