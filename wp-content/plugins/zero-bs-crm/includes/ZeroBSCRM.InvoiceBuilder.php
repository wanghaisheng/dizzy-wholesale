...
function zeroBSCRM_replace_invoice_submit_meta_box() 
{
        ...
        require_once(ZEROBSCRM_PATH . 'includes/ZeroBSCRM.MetaBoxes.SubmitBoxes.php');
...
#} Generates the HTML of an invoice based on the template in html/invoices/invoice.html
    ...
    if (!empty($invoiceID)){
        ...
        if (function_exists('file_get_contents')){
            ...
            try {
                ...
                $templatedHTML = zeroBSCRM_retrievePDFTemplate('default');
        ...
        if (!empty($templatedHTML)){
            ...
            $templatedHTML = str_replace('###MSGCONTENT###',$message_content,$templatedHTML);
        ...
        if (!empty($templatedHTML)){
            ...
            #} Mikes previous invoice.php worked into vars:
                ...
                /*
                    ...
                    <div class="zbs-line-info zbs-line-info-title">Business name</div>
                    <div class="zbs-line-info">Business Owner Name Here</div>
                    <div class="zbs-line-info"> Aliquam vel diam sed ligula Extra Infos</div>
                    <div class="zbs-line-info">Business E-mail@email.com</div>
                    <div class="zbs-line-info">www.google.com.br</div>   
                ...
                */
                    ...
                    $custInfoTable = '<div class="zbs-line-info zbs-line-info-title">'.$invTo['fname'].' ' .$invTo['lname'] . '</div>';
                            $custInfoTable .= '<div class="zbs-line-info">'.$invTo['addr1'].'</div>';
                            $custInfoTable .= '<div class="zbs-line-info">'.$invTo['addr2'].'</div>';
                            $custInfoTable .= '<div class="zbs-line-info">'.$invTo['city'].'</div>';
                            $custInfoTable .= '<div class="zbs-line-info">'.$invTo['postcode'].'</div>';


                
                $tableHeaders = '';

                $tableHeaders = '<th style="text-align:left;"><span class="table-title">'.__('Description','zerbscrm').'</span></th>';
                ...
                <tr class="">
                    <td style="width:55%"><span class="item-name">Item Name</span><span class="item-description">Item Description here</span></td>
                    <td style="width:15%;text-align:center;" class="cen">5</td>
                    <td style="width:15%;text-align:center;"class="cen">$ 20</td>
                    <td style="width:15%;text-align:right;" class="row-amount">$ 100</td>
                </tr>
            ...
            <table id="invoice_totals" class="table-totals zebra" style="width: 100%;">
                <tbody>
                    <tr class='total-top'>
                        <td  class='bord bord-l' style="text-align:right; width: 80%; text-transform: uppercase;">
                            Subtotal
                        </td>
                        <td class='bord row-amount' class='bord' style="text-align:right; "><span class='zbs-totals'>$ 228.00</span>
                        </td>
                    </tr>


                    <tr class='discount'>
                        <td class='bord bord-l' style="text-align:right; text-transform: uppercase;">
                            Discount
                        </td>
                        <td class='bord row-amount' id="zbs_discount_combi" style="text-align:right"><span class='zbs-totals'>$ 11.75</span></td>
                    </tr>
                    ...
                    <tr class='postage_and_pack'>
                        ...
                        <td class='bord row-amount' id="pandptotal" style="text-align:right;"><span class='zbs-totals'>$ 12.75</span></td>
                    </tr>
                    <tr class="ttclass">
                        <td class='bord bord-l' style="text-align:right">
                            Tax
                        </td>
                        <td class='bord bord-l row-amount zbs-tax-total-span' style="text-align:right"><span class='zbs-totals'>$ 13.75</span></td>
                    </tr>


                    <tr class="zbs_grand_total" style="line-height:30px;">
                        <td class='bord-l'  style="text-align:right; color: #111;font-weight:800;  border-radius: 0px;"><span class='zbs-total'>Total</span></td>
                        <td class='row-amount' style="text-align:right; font-weight:800; border: 3px double #111!important; "><span class='zbs-total'>$ 242.75</span></td>
                    </tr>
                </tbody>
                ...
                */
                ...
                $totalsTable = '';
                    ...
                    $totalsTable .= '<table id="invoice_totals" class="table-totals zebra" style="width: 100%;"><tbody>';
                        ...
                        <td class="bord-l"  style="text-align:right; color: #111;font-weight:800;  border-radius: 0px;"><span class="zbs-total">'.__("Total","zero-bs-crm").'</span></td>
                        <td class="row-amount" style="text-align:right; font-weight:800; border: 2px solid #e1def3!important; "><span class="zbs-total">';
            ...
            /*
                ...
                <div class="deets">
                    ...
                    <div class="deets-line"><span class="deets-content">john.doe@gmail.com</span></div>
                    <div class="deets-line"><span class="deets-title">Payment Reference:</span> <span class="deets-content">INV #5561</span></div>
                </div>
            ...
            */
            ...
            #} replace the vars
            $html = str_replace('###INVOICETITLE###',__('Invoice','zero-bs-crm'),$templatedHTML);  
            $html = str_replace('###CSS###',$cssURL,$html);
            ...
            $html = str_replace('###INVIDSTYLES###','',$html);  // not used <3.0 
            ...
            $html = str_replace('###PAYMENTDEETS###',$payDetails,$html);    
            ...
            $html = str_replace('###PARTIALSTABLE###',$partialsTable,$html);    
             ...
             // WH: Notice there's no $subLine? $html = str_replace('##UNSUB-LINE##',$subLine,$html);  
             $html = str_replace('##UNSUB-LINE##','',$html);
             $html = str_replace('###FOOTERUNSUBDEETS###','',$html); // legacy  

             ##WLREMOVE
             $html = str_replace('###POWEREDBYDEETS###','Powered by <a href="https://jetpackcrm.com" style="color:#3498db;text-decoration:underline;color:#999999;font-size:12px;text-align:center;text-decoration:none;">Jetpackcrm.com</a>.',$html); 
             ##/WLREMOVE
             $html = str_replace('###POWEREDBYDEETS###','',$html); 


            // == LANGUAGE replacements
            $ref_label = $zbs->settings->get('reflabel');

            $html = str_replace('###LANGINVNO###', __( 'Invoice Number:', 'zero-bs-crm' ), $html );
            $html = str_replace('###LANGINVDATE###', __( 'Invoice Date:', 'zero-bs-crm' ), $html );
            $html = str_replace('###LANGINVREF###', $ref_label, $html );
            $html = str_replace('###LANGFROM###', __( 'From:', 'zero-bs-crm' ), $html );
            $html = str_replace('###LANGTO###', __('To:','zero-bs-crm'), $html );
            $html = str_replace('###LANGDUEDATE###', __('Due date:', 'zero-bs-crm' ), $html );
...
function zeroBSCRM_invoice_generatePortalInvoiceHTML_v3($invoiceID=-1,$return=true){
    ...
    if (!empty($invoiceID)){
        ...
        if (!empty($templatedHTML)){
            ...
            // this was refactored as was duplicate code.
            // now all wired through zeroBSCRM_invoicing_generateInvoiceHTML
            $html = zeroBSCRM_invoicing_generateInvoiceHTML($invoiceID,'portal',$templatedHTML);
    ...
    if (!empty($invoicePostID)){
        ...
        if (!empty($templatedHTML)){
            ...
            #} Mikes previous invoice.php worked into vars:
                ...
                if($zbs_stat == 'Paid'){
                    $topStatus .= '<div class="zbs-invoice-paid"><i class="fa fa-check"></i>' . __("Paid") . '</div>';   
                }
                ...
                $bizInfoTable = '';
                    ...
                    $bizInfoTable .= '<div class="zbs-portal-label">' . __('Pay To') . '</div>';
                    ...
                    $custInfoTable .= '<div class="zbs-portal-label">' . __('Invoice To') . '</div>';
                        $custInfoTable .= '<div class="zbs-portal-biz">';
                            if (isset($invTo['fname']) && isset($invTo['fname'])) $custInfoTable .= '<div class="pay-to-name">'.$invTo['fname'].' ' .$invTo['lname'] . '</div>';
                            if (isset($invTo['addr1'])) $custInfoTable .= '<div>'.$invTo['addr1'].'</div>';
                            if (isset($invTo['addr2'])) $custInfoTable .= '<div>'.$invTo['addr2'].'</div>';
                            if (isset($invTo['city'])) $custInfoTable .= '<div>'.$invTo['city'].'</div>';
                            if (isset($invTo['postcode'])) $custInfoTable .= '<div>'.$invTo['postcode'].'</div>';
                        $custInfoTable .= '</div>';
                    $custInfoTable .= '</div>';
                    ...
                    $totalsTable .= '<table id="invoice_totals" style="width:100%;">';
                        ...
                        $totalsTable .= '</tr>';
                         ...
                         $totalsTable .= '<tr class="zbs_grand_total" style="line-height:30px;">';
                            ...
                            $totalsTable .= '<td class="bord bord-l" colspan="3" style="text-align:right;background:#f5f5f5;font-weight:800">'.__("Total","zero-bs-crm").'</td>';
                            $totalsTable .= '<td class="bord row-amount" colspan="2" style="text-align:right;background:#f5f5f5;font-weight:800">';
            ...
            $html = str_replace('###LANGTO###',__('To:','zero-bs-crm'),$html);
            $html = str_replace('###LANGDUEDATE###',__('Due date:','zero-bs-crm'),$html);
            $html = str_replace('###PAYMENTTERMS###',__('Payment Terms: Due ','zero-bs-crm'),$html);
...
function zeroBSCRM_generateInvoicePDFFile($invoiceID=-1){
    ...
    if ($zbs->isDAL3()){
        ...
        // brutal.
        if (!zeroBSCRM_permsInvoices()) return false;
...
#} Generates the HTML of an invoice based on the template in html/invoices/statement.html
#} if $return, it'll return, otherwise it'll echo + exit
    ...
    if (!empty($contactID) && $contactID > 0){
        ...
        if (function_exists('file_get_contents')){
            ...
            try {
                ...
                $templatedHTML = zeroBSCRM_retrievePDFTemplate('statement');
...
function zeroBSCRM_invoicing_generateStatementHTML_v3($contactID=-1,$return=true,$templatedHTML=''){
    ...
    if ($contactID > 0 && $templatedHTML !== ''){
            ...
            $statementTable .= '<tr>';
                ...
                // contact address
                    ...
                    if (is_array($contactDetails) && isset($contactDetails['fname'])){
                        $custInfoTable = '<div class="zbs-line-info zbs-line-info-title">'.$contactDetails['fname'].' ' .$contactDetails['lname'] . '</div>';
                        if (isset($contactDetails['addr1']) && !empty($contactDetails['addr1'])) $custInfoTable .= '<div class="zbs-line-info">'.$contactDetails['addr1'].'</div>';
                        if (isset($contactDetails['addr2']) && !empty($contactDetails['addr2'])) $custInfoTable .= '<div class="zbs-line-info">'.$contactDetails['addr2'].'</div>';
                        if (isset($contactDetails['city']) && !empty($contactDetails['city'])) $custInfoTable .= '<div class="zbs-line-info">'.$contactDetails['city'].'</div>';
                        if (isset($contactDetails['county']) && !empty($contactDetails['county'])) $custInfoTable .= '<div class="zbs-line-info">'.$contactDetails['county'].'</div>';
                        if (isset($contactDetails['postcode']) && !empty($contactDetails['postcode'])) $custInfoTable .= '<div class="zbs-line-info">'.$contactDetails['postcode'].'</div>';
                    }

                    // add
                    $statementTable .= '<td><div style="text-align:left">'.$custInfoTable.'</div></td>';
        ...
        // STATEMENT table
            ...
            $sTable = '<table border="0" cellpadding="0" cellspacing="0" class="body" style="border-collapse:collapse;mso-table-lspace:0pt;mso-table-rspace:0pt;background-color:#FFF;width:100%">';
                ...
                if (is_array($invoices) && count($invoices) > 0){
                    ...
                    // No invoices?           
                    $sTable .= '<tr><td colspan="6" style="text-align:center;font-size:14px;font-weight:800;padding:2em">'.__('No Activity','zero-bs-crm').'</td></tr>';
        ...
        #} replace the vars
            ...
            // main content
            $html = str_replace('###STATEMENTHTML###',$statementTable,$templatedHTML);   
...
function zeroBSCRM_invoicing_generateStatementHTML_prev3(){
            ...
            // STATEMENT table
                ...
                $sTable = '<table border="0" cellpadding="0" cellspacing="0" class="body" style="border-collapse:collapse;mso-table-lspace:0pt;mso-table-rspace:0pt;background-color:#FFF;width:100%">';
                    ...
                    if (is_array($invoices) && count($invoices) > 0){
                        ...
                        // No invoices?           
                        $sTable .= '<tr><td colspan="7" style="text-align:center;font-size:14px;font-weight:800;padding:2em">'.__('No Activity','zero-bs-crm').'</td></tr>';
            ...
            #} replace the vars
                ...
                // general replaces
                /* no longer req (now using pdf-statement.html
                $html = str_replace('###TITLE###', __('Statement','zero-bs-crm'), $html);  
                $html = str_replace('###FOOTERBIZDEETS###','',$html);  
                $html = str_replace('##UNSUB-LINE##','',$html);  
                $html = str_replace('###FOOTERUNSUBDEETS###','',$html); // legacy version of UNSUB-DETAILS                        
                $html = str_replace('###POWEREDBYDEETS###','',$html); // legacy version of POWERED-BY
...
// ... 3) Invoice email notification Gen (zeroBSCRM_invoice_generateNotificationHTML in Templating.php)
...
function zeroBSCRM_invoicing_generateInvoiceHTML($invoiceID=-1,$template='pdf',$html=''){
    ...
    #} Mikes previous invoice.php worked into vars:
        ...
        */
        ...
        /* now produced by centralisd func (which splits depending on portal, pdf etc.)
        $bizInfoTable = '<div class="zbs-line-info zbs-line-info-title">'.$zbs_biz_name.'</div>';
                $bizInfoTable .= '<div class="zbs-line-info">'.$zbs_biz_yourname.'</div>';
                $bizInfoTable .= '<div class="zbs-line-info">'.nl2br($zbs_biz_extra).'</div>';
                $bizInfoTable .= '<div class="zbs-line-info">'.$zbs_biz_youremail.'</div>';
        ...
        $custInfoTable = zeroBSCRM_invoicing_generateInvPart_custTable($invTo,$template);
        ...
        $totalsTable = '';
            ...
            $totalsTable .= '<table id="invoice_totals" class="table-totals zebra" style="width: 100%;"><tbody>';
                ...
                $totalsTable .= '<tr class="zbs_grand_total" style="line-height:30px;">
                <td class="bord-l"  style="text-align:right; color: #111;font-weight:800;  border-radius: 0px;"><span class="zbs-total">'.__("Total","zero-bs-crm").'</span></td>
                <td class="row-amount" style="text-align:right; font-weight:800; border: 3px double #111!important; "><span class="zbs-total">';
            ...
            $partialsTable = '';
                ...
                if (is_array($partials) && count($partials) > 0){
                    ...
                    // header
                    $partialsTable .= '<tr><td colspan="2" style="text-align:center; color: #111;font-weight:800;  border-radius: 0px;"><span class="zbs-total">'.__('Payments','zero-bs-crm').'</span></td></tr>';
                ...
                $partialsTable .= '<tr class="zbs_grand_total'.$balance_hide.'">';
                    $partialsTable .= '<td class="bord bord-l" style="text-align:right; color: #111;font-weight:800;  border-radius: 0px;"><span class="zbs-minitotal">'.__("Amount due","zero-bs-crm").'</td>';
                    $partialsTable .= '<td class="bord row-amount"><span class="zbs-subtotal-value">'.zeroBSCRM_formatCurrency($balance).'</span></td>';
                $partialsTable .= '</tr>';
                $partialsTable .= '</table>';

                #} Invoicing PRO integration
                // WH: think this is all your legacy code, for now using the below which looks modern + correct.
                    #} Changed this to a filter, to avoid global call :) 
                    # global $invpp; $invpp = '';
                    # do_action('invoicing_pro_paypal_button', $invoiceID);   //this is where we can add_action('invoicing_pro_paypal_button')
                    //  $potentialPayButton = apply_filters('invoicing_pro_paypal_button', $invoiceID);
                    //if (!empty($potentialPayButton) && gettype($potentialPayButton) == 'string') $partialsTable .= $potentialPayButton;                
    ...
    #} == Template -> HTML build
        ...
        $html = str_replace('###INVNOSTR###',$invNoStr,$html);  
        $html = str_replace('###INVDATESTR###',$invDateStr,$html); 
        $html = str_replace('###INVIDSTYLES###',$invIDStyles,$html);
        $html = str_replace('###INVREFSTYLES###',$invRefStyles,$html);
        $html = str_replace('###REF###',$invNoStr,$html); 
        $html = str_replace('###DUEDATE###',$dueDateStr,$html);  
        $html = str_replace('###TOPSTATUS###', $topStatus, $html); // only used in portal template :)
        ...
        if (!empty($partialsTable)){
            ...
            $html = str_replace('###PARTIALSTABLE###',$partialsTable,$html); 
            $html = str_replace('###PREPARTIALS###',$payDetails,$html); 
            $html = str_replace('###PAYMENTDEETS###','',$html); 
            $html = str_replace('###PAYDETAILS###', '', $html); // variant of PAYMENTDEETS used in some templates

        } else {

            // no partials, normal output
            $html = str_replace('###PARTIALSTABLE###','',$html); 
            $html = str_replace('###PAYMENTDEETS###',$payDetails,$html); 
            $html = str_replace('###PAYDETAILS###', $payDetails, $html); // variant of PAYMENTDEETS used in some templates
...
function zeroBSCRM_invoicing_generateInvPart_custTable($invTo=array(),$template='pdf'){
    ...
    $custInfoTable = '<div class="customer-info-wrapped">';
        ...
        switch ($template){
            ...
            case 'notification':
                ...
                if (isset($invTo['fname']) && isset($invTo['fname'])) $custInfoTable .= '<div class="zbs-line-info zbs-line-info-title">'.$invTo['fname'].' ' .$invTo['lname'] . '</div>';
                if (isset($invTo['addr1'])) $custInfoTable .= '<div class="zbs-line-info">'.$invTo['addr1'].'</div>';
                if (isset($invTo['addr2'])) $custInfoTable .= '<div class="zbs-line-info">'.$invTo['addr2'].'</div>';
                if (isset($invTo['city'])) $custInfoTable .= '<div class="zbs-line-info">'.$invTo['city'].'</div>';
                if (isset($invTo['county'])) $custInfoTable .= '<div class="zbs-line-info">'.$invTo['county'].'</div>';
                if (isset($invTo['postcode'])) $custInfoTable .= '<div class="zbs-line-info">'.$invTo['postcode'].'</div>';
                if (isset($invTo['country'])) $custInfoTable .= '<div class="zbs-line-info">'.$invTo['country'].'</div>';
            ...
            case 'portal':
                ...
                $custInfoTable .= '<div class="pay-to">';
                    $custInfoTable .= '<div class="zbs-portal-label">' . __('Invoice To') . '</div><div style="margin-top:18px;">&nbsp;</div>';
                    $custInfoTable .= '<div class="zbs-portal-biz">';
                        if (isset($invTo['fname']) && isset($invTo['fname'])) $custInfoTable .= '<div class="pay-to-name">'.$invTo['fname'].' ' .$invTo['lname'] . '</div>';
                        if (isset($invTo['addr1'])) $custInfoTable .= '<div>'.$invTo['addr1'].'</div>';
                        if (isset($invTo['addr2'])) $custInfoTable .= '<div>'.$invTo['addr2'].'</div>';
    ...
    $custInfoTable = apply_filters('zbs_invoice_customer_info_table', $custInfoTable);

    return $custInfoTable;
}
            ...
            case 'pdf':
                ...
                if ($invlines != ''){
                    ...
                    foreach($invlines as $invline){
                        ...
                        $lineItemHTML .= 
                        '<tr>
                                    <td style="width:55%;"><div class="item-name">'.$invline['title'].'</div><div class="item-description">'.$invline['desc'].'</div></td>
            ...
            case 'portal':
                ...
                if ($invlines != ''){
                    ...
                    foreach($invlines as $invline){
                        ...
                        '<tbody class="zbs-item-block" data-tableid="'.$i.'" id="tblock'.$i.'">
                                <tr class="top-row">
                                    <td style="width:50%">'.$invline['title'].'<br/><span class="dz">'.$invline['desc'].'</span></td>
                ...
                if ($invlines != ''){
                    ...
                    foreach($invlines as $invline){
                        ...
                        foreach($invlines as $invline){
                            ...
                            $lineItemHTML .= '
                                    <tr class="top-row">
                                        <td style="width:70%;font-weight:800">'.$invline['title'].'</td>
    ...
    $tableHeaders = '';
        ...
        switch ($template){
            ...
            case 'portal':
                ...
                $tableHeaders = '<th class="left">'.__('Description','zerbscrm').'</th>';
