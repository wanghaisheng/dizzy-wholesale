...
class zbsDAL_ObjectLayer {
        ...
        if (!empty($typeStr)) {
            ...
            if (isset($customFields) && is_array($customFields)){
                ...
                foreach ($customFields as $fieldKey => $field){
                    ...
                    // hidden?
                    if ( $includeHidden || ( is_array( $fieldsToHide ) && ! in_array( $fieldKey, $fieldsToHide ) ) ) {
     ...
     * ... (verfiyNonEmptyValues) if that attribute is specified in the obj model
     *
     ...
     * @return bool
     */
    public function verfiyUniqueValues($objArr=array(),$id=-1){
     ...
     * @return bool
     */
    public function verfiyNonEmptyValues($objArr=array()){
