...
function zeroBSCRM_scriptStyles_initStyleRegister(){
	...
	global $zbs;
		...
		// ============  Page-specific  ==============
			...
			// home dash
			wp_register_style('zerobscrmhomedash', 	plugins_url('/css/ZeroBSCRM.admin.homedash.min.css',ZBS_ROOTFILE),'zbs-wp-semanticui', '2.12' );
...
function zeroBSCRM_admin_styles_homedash(){
	...
	zeroBSCRM_enqueue_libs_js_momentdatepicker();
	wp_register_script('zerobscrmjs-dash' , ZEROBSCRM_URL .'/js/ZeroBSCRM.admin.dash.js', array('jquery'));
