			        ...
			        <div class="simple" style="border:0px !important">
			            <div class="content">
			                ...
			                <div class="zbsForm_success"><?php echo !empty($formObject['label_successmsg']) ? $formObject['label_successmsg'] : __("Thanks. We will be in touch.",'zero-bs-crm'); ?></div>
			              	<?php if(zeroBSCRM_getSetting('showformspoweredby')){ 
								##WLREMOVE
							?>
			                <div class="zbs_poweredby" style="font-size:11px;">powered by: <a href="https://jetpackcrm.com/" target="_blank">Jetpack CRM</a></div>
							<?php 
								##/WLREMOVE	 
							} ?>
			            </div>
