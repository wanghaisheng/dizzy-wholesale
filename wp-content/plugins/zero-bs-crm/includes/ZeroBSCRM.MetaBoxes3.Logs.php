        ...
        global $zbs;
            ...
            <script type="text/javascript">
                ...
                function zbscrmjs_bindNoteUIJS(){
                    ...
                    // bind del
                    jQuery('.zbsLogOutEdits .zbsLogActionRemove').off('click').click(function(){
                    ...
                    // bind edit
                    jQuery('.zbsLogOutEdits .zbsLogActionEdit').off('click').click(function(){
