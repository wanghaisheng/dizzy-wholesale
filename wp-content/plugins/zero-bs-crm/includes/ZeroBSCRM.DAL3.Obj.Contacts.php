...
class zbsDAL_contacts extends zbsDAL_ObjectLayer {
    ...
    public function getContacts($args=array()){
        ...
        #} ============= PRE-QUERY ============
            ...
            #} If just count, turn off any extras
            if ($count) {
            ...
            if ($withDND){
                ...
                // add as subquery
                $extraSelect .= ',(SELECT zbsm_val FROM '.$ZBSCRM_t['meta']." WHERE zbsm_objid = contact.ID AND zbsm_key = %s AND zbsm_objtype = ".ZBS_TYPE_CONTACT.") dnd";
