   ...
   ====================================================== */
	...
	#} ================================================================================
		...
		$zeroBSCRM_Conf_Def = array( 
											...
											'unsubmsg' => 'You have been sucessfully unsubscribed.',
											...
											'customviews2' => array(
												...
												'customer_filters' => array(
											        ...
											        'lead' => array('Lead'),
											        'customer' => array('Customer')
											        // don't add as default - currency woes over100' => array('Over 100')
												),
											...
											#} TO BE SORTED
											'transinclude_status' => 'Succeeded,Completed',


											#} WH Language Lib compliant text overrides
											'whlang' => array(
