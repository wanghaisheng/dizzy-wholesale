...
<div id="sbA">
    ...
    <form method="post" action="?page=<?php echo $zbs->slugs['settings']; ?>&tab=transactions">
        ...
        <table class="table table-bordered table-striped wtab">
            ...
            <tr>
                <td class="wfieldname"><label for="wpzbscrm_transinclude"><?php _e('Include these statuses in total value',"zero-bs-crm"); ?>:</label><br /><?php _e('Tick which statuses to include when calculating total transaction value and total overall value of contacts.',"zero-bs-crm"); ?>
                    <br /><br /></td>
        ...
        <table class="table table-bordered table-striped wtab">
            ...
            <tr>
                <th colspan="2" class="wmid"><?php _e('Transaction Field Options',"zero-bs-crm"); ?>:</th>
            </tr>
