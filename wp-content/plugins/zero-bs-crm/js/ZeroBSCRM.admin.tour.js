      ...
      steps: [
        {
          ...
          placement: "right",
          yOffset: -15
          //yOffset: -(jQuery("#learn").outerHeight()/2), - this was a hack to center align, didn't work, hard typed
        },
        {
        ...
        },
        {
          ...
          placement: "left",
          showPrevButton: true,
          yOffset: -(jQuery("#notty").outerHeight()/2),
            onNext: function() {
...

        {
          ...
          target: "top-bar-tools-menu",//"zbs-extensions-topmenu",
          placement: "left",
          showPrevButton: true,
          onShow: function() {
        ...
        // XXX
        {
          ...
          target: "zbs-manage-ext-tour",//"zbs-extensions-topmenu",
          placement: "left",
          multipage: true,
          showPrevButton: true,
          yOffset: -16,
