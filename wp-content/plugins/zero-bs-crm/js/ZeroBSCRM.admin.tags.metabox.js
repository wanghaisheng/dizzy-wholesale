...
function zbsJS_bindTags(){
    ...
    // remove tag
    jQuery('.zbs-remove-tag').off('click').click(function(){
...
function zbsJS_bindTagsInit(){
    ...
    // add tags
    jQuery('#zbs-add-tag-action').off('click').click(function(){
    ...
    // add tag return key
    jQuery('#zbs-add-tag-value').keypress(function(event){
      if(event.keyCode == 13){
        // old way
        //jQuery('#zbs-add-tag-action').click();
    ...
    jQuery('#zbs-tag-suggestions-show-more').off('click').click(function(){
    ...
    jQuery('#zbs-tag-suggestions-show-less').off('click').click(function(){
    ...
    // use a suggestion
    jQuery('.zbsTagSuggestion').off('click').click(function(){
...
function zeroBSCRMJS_tagManager_bindTagEditButtons(){
  ...
  jQuery('.zbs-delete-tag').unbind('click').click(function(){
