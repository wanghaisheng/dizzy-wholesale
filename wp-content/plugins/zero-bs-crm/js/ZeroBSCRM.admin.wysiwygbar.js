...
(function() {
	...
	// catch
	if (typeof window.zbsCRMFormList == "undefined") window.zbsCRMFormList = [{text:'No Forms Available',value:-1}];

    tinymce.PluginManager.add('zbsCRMForms', function( editor, url ) {
        
		var thisTitle = 'CRM Forms';
		if (typeof window.zbs_root.crmname != "undefined") thisTitle = window.zbs_root.crmname + ' Forms';

		var thisIco = window.zbs_root.root  + "i/WYSIWYG_icon.png";
		if (typeof window.zbs_root.crmlogo != "undefined") thisIco = window.zbs_root.root  + window.zbs_root.crmlogo;
